...
final class SolanaSwiftTests: XCTestCase {
    ...
    func testVersionedTransaction() throws {
        let data = Data(hex: "")
        var binaryReader = BinaryReader(bytes: data.bytes)
        let signedTx = try SolanaSignedVersionedTransaction.init(from: &binaryReader)
        switch signedTx.version {
        case .legacy:
            let tx = (signedTx.transaction as! SolanaTransaction)
            tx.instructions.forEach { i in
                debugPrint(i.toHuman())
            }
            break
        case .v0:
            let tx = (signedTx.transaction as! SolanaVersionedTransaction)
            tx.instructions.forEach { i in
                debugPrint(i.toHuman())
            }
            break
